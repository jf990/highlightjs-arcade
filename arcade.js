...
function hljsDefineArcade(hljs) {
    ...
    var KEYWORDS = {
      ...
      built_in:
        ...
        'FeatureSetByRelationship FeatureSetByTitle FeatureSetByUrl Filter First Floor Geometry GroupBy Guid HasKey Hour IIf IndexOf ' +
...
module.exports = function(hljs) {
    hljs.registerLanguage("arcade", hljsDefineArcade);
};
  
module.exports.definer = hljsDefineArcade;
